    ...
    <figure className={className ?? "group"}>
      <picture>
        ...
        <img
          ...
          alt={alt}
          loading="lazy"
          className="w-full rounded-xl border border-zinc-200 dark:border-zinc-800 shadow-sm bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-zinc-800 dark:to-zinc-900"
          onError={(e) => {
