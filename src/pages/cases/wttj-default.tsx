...
export default function WttjDefaultCase() {
  return (
    <main id="top" className="mx-auto max-w-4xl px-4 md:px-6 lg:px-8 py-10 space-y-12">
      {/* Hero */}
      ...
      {/* >>> Mise en avant du Prototype (nouvelle section) */}
      ...
      <section className="space-y-4">
        ...
        <CaseImage
          ...
          caption="Priorisation RICE du MVP"
        />
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-6 items-start">
        <div className="space-y-3">
          ...
          <p>Maquette Figma → finalisation & publication Lovable → <b>4 tests utilisateurs</b> issus de la discovery.</p>
      ...
      <section className="space-y-4">
        ...
        <CaseImage
          ...
          caption="Objectifs mesurables post-MVP"
        />
      </section>
      ...
      <section className="grid md:grid-cols-2 gap-6 items-start">
        ...
        <CaseImage
          ...
          caption="Gestion des risques & parades"
        />
      </section>

      {/* Vue d’ensemble du projet (mosaïque visuelle — option) */}
      {/* Si tu utilises déjà <CaseOverview />, insère-le ici */}
      ...
      <footer className="pt-4 border-t">
        <ul className="list-disc pl-5 space-y-1 text-sm">
          <li><a className="underline" href="https://prototype-wttj.lovable.app/" target="_blank" rel="noreferrer">Prototype Lovable</a></li>
