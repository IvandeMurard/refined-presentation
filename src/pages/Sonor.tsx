// src/pages/Sonor.tsx - VERSION FINALE COMPLÈTE AVEC SOMMAIRE
...
// ============= SOMMAIRE STICKY =============
const TableOfContents = ({ sections }: { sections: { id: string; label: string }[] }) => {
      ...
      <div className="space-y-1 text-sm">
        {sections.map(({ id, label }) => (
          <button
            ...
            className={`block text-left w-full px-3 py-2 rounded-lg transition-colors ${
              activeSection === id
...
const ContentDefaultFR = () => {
  ...
  const tocSections = [
    { id: "contexte", label: "Contexte & Déclencheur" },
    { id: "role", label: "Mon rôle" },
    { id: "process", label: "Process & Méthodologie" },
    { id: "resultats", label: "Résultats" },
    { id: "moments-cles", label: "Moments clés" },
    { id: "segmentation", label: "Segmentation & Ciblage" },
    { id: "sprints", label: "Sprints & Cadences" },
    { id: "refaire", label: "Si c'était à refaire" },
    { id: "epilogue", label: "Épilogue & Apprentissages" },
    ...
    <div className="relative">
      ...
      <div className="max-w-[1400px] mx-auto px-4">
        <div className="flex gap-8">
          {/* Sommaire sticky (caché sur mobile/tablet) */}
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Section 1: Contexte */}
            <div id="contexte" className="py-16 scroll-mt-24">
            ...
            {/* Section 2: Mon rôle */}
            <div id="role" className="py-16 bg-secondary/50 -mx-4 px-4 scroll-mt-24">
            ...
            <div id="process" className="py-16 scroll-mt-24">
              <div className="space-y-10">
            ...
            {/* Section 4: Résultats */}
            <div id="resultats" className="py-16 bg-secondary/50 -mx-4 px-4 scroll-mt-24">
              <div className="space-y-10">
            ...
            <div id="moments-cles" className="py-16 scroll-mt-24">
              <div className="space-y-10">
            ...
            <div id="segmentation" className="py-16 bg-secondary/50 -mx-4 px-4 scroll-mt-24">
              <div className="space-y-10">
            ...
            <div id="sprints" className="py-16 scroll-mt-24">
              <div className="space-y-10">
            ...
            <div id="refaire" className="py-16 bg-secondary/50 -mx-4 px-4 scroll-mt-24">
              <div className="space-y-10">
            ...
            <div id="epilogue" className="py-16 scroll-mt-24">
              <div className="space-y-10">
            ...
            {/* Section 10: À propos */}
            <div id="apropos" className="py-16 bg-secondary/50 -mx-4 px-4 scroll-mt-24">
              <div className="space-y-6">
...
const ContentDefaultEN = () => {
  ...
  const tocSections = [
    { id: "context", label: "Context & Trigger" },
    { id: "role", label: "My Role" },
    { id: "process", label: "Process & Method" },
      ...
      <div className="max-w-[1400px] mx-auto px-4">
        <div className="flex gap-8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div id="context" className="py-16 scroll-mt-24">
              <div className="space-y-10">
                <section className="grid md:grid-cols-2 gap-6 items-start">
                  <div className="space-y-4">
            ...
            <div id="results" className="py-16 bg-secondary/50 -mx-4 px-4 scroll-mt-24">
              <div className="space-y-10">
            ...
            <div id="learnings" className="py-16 scroll-mt-24">
              <div className="space-y-10">
