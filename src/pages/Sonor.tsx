  ...
  return (
    <span className="inline">
      ...
      <InlineExpand open={open} ariaId={id}>
        <div id={`${id}-panel`} className="mt-2 p-3 rounded-lg border-l-4 border-accent bg-muted/60 text-sm italic">
...
const TLDRBlockFR = () => (
  <CaseTldr
    ...
    items={[
      <>
        <b>Solution :</b> Une offre 360° de plateforme SaaS{" "}
        <TermExplain term="open data">données publiques librement accessibles et réutilisables</TermExplain> pour villes
        et métropoles : de la cartographie de la pollution sonore aux recommandations d'action publique, et l'engagement
        citoyen via la sensibilisation sur les actions de la collectivité
      </>,
      <>
        <b>Sources de données :</b> NoiseModeling, NoisePlanet, et données ouvertes des collectivités (obligation légale
        pour villes &gt;3 500 habitants et agglomérations &gt;100 000 habitants)
      </>,
      <>
        <b>Équipe :</b> 4 co-fondateurs (Émilie, Majda, Benjamin, Ivan) + 1 dev/data-scientist à temps partiel
      </>,
      <>
        <b>Mon rôle :</b> Product framing,{" "}
        <TermExplain term="discovery">phase de recherche utilisateur et marché approfondie</TermExplain> (20
        entretiens), Prototypage (UX/UI Figma), Go-to-Market{" "}
        <TermExplain term="B2G">Business-to-Government, ventes aux collectivités publiques</TermExplain>, Sales,
        Pilotage d'un développeur data-scientist
      </>,
      <>
...
const TLDRBlockEN = () => (
  <CaseTldr
    ...
    items={[
      <>
        <b>Solution:</b> A 360° SaaS platform offering for cities: from noise pollution mapping to public action
        recommendations and citizen engagement
      </>,
      <>
        <b>Data sources:</b> NoiseModeling, NoisePlanet, and open data from municipalities (legal obligation for cities
        &gt;3,500 inhabitants and agglomerations &gt;100,000 inhabitants)
      </>,
      <>
        <b>Team:</b> 4 co-founders (Émilie, Majda, Benjamin, Ivan) + 1 part-time dev/data-scientist
      </>,
      <>
        <b>My role:</b> Product framing, discovery (20 interviews), Prototyping (UX/UI Figma), B2G go-to-market, Sales,
    ...
    <div>
        ...
        <div className="max-w-6xl mx-auto space-y-10">
          <section className="grid md:grid-cols-2 gap-6 items-start">
            <div className="space-y-4">
              ...
              <p>
                Le projet <b>SONOR</b> naît en octobre 2020 grâce au <b>Hackathon Recoder l'Habitat #2</b> portant sur
                la thématique de l'Habitat et de la Santé. Lors du hackathon, le constat de la pollution sonore est
                fait, l'équipe est formée, le travail de définition de la solution et de prototypage commence. 24h
                après, l'équipe Sonor (Émilie, Majda, Benjamin, et moi Ivan) remporte ce hackathon, présentant un outil
                de diagnostic complet de la pollution sonore dans une ville à partir d'
                <TermExplain term="open data">données publiques librement accessibles</TermExplain> : cartographie,
                recommandations d'actions publiques, suivi de la réglementation et alertes citoyennes, notre plateforme
                séduit.
              </p>
              <p>
                Sonor obtient une bourse et un accompagnement par l'<b>Association Matrice Loi 1901</b> et{" "}
                <b>La Banque des Territoires</b>, l'aventure entrepreneuriale est lancée. Problématique à résoudre : la{" "}
                <b>pollution sonore</b>, 2ème source de nuisances urbaines aux impacts sanitaires, sociaux, et
                environnementaux significatifs, est invisible, insidieuse et peu adressée.
              </p>
              <p>
                <b>Solution :</b> Offrir une solution{" "}
                <TermExplain term="SaaS">
                  Software as a Service, logiciel accessible en ligne par abonnement
                </TermExplain>{" "}
                open data pour permettre aux villes de <b>mesurer, cartographier</b> et <b>réduire</b> durablement la
                pollution sonore, accompagner les collectivités dans le déploiement de solutions adaptées et favoriser
                la collaboration entre service public, citoyens, et acteurs privés.
              </p>
              <p>
                <b>Proposition de valeur :</b> Anticiper et agir sur le bruit pour garantir la santé des habitants et
      ...
      <div className="py-16 px-4 md:px-8 bg-background">
        <div className="max-w-6xl mx-auto space-y-10">
          <h2 className="text-h3">
            ...
            <TermExplain term="Agile Lean">méthodologie itérative et incrémentale centrée sur la valeur</TermExplain>)
          </h2>
      ...
      <div className="py-16 px-4 md:px-8 bg-secondary">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <ExpandSection id="acteurs-rencontres" title="Acteurs rencontrés">
            <p>
              <b>Typologie :</b> Métropoles régionales, villes moyennes, collectivités territoriales, acteurs publics
              locaux
            </p>
            <p>
              <b>Partenaires techniques et institutionnels :</b> BruitParif, CSTB, CNRS, Qualitel, CDC Habitat, Icade,
              OGIC, Ministère de l'Écologie
            </p>
          </ExpandSection>
      ...
      <div className="py-16 px-4 md:px-8 bg-background">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <ExpandSection id="cycles-vente" title="Les cycles de vente B2G">
            <p>
              Les cycles de vente auprès des collectivités sont particulièrement longs (6-12 mois minimum). Malgré des
              échanges constructifs avec plusieurs collectivités, nous avons manqué de temps pour finaliser les
              signatures.
            </p>
            <div className="space-y-3 mt-4">
              <div>
                ...
                <p className="text-sm">
                  Difficulté à faire rentrer le projet dans les budgets pluriannuels déjà engagés. La pollution sonore
                  reste un enjeu secondaire face aux priorités budgétaires.
                </p>
              </div>
              <div>
                <p className="font-semibold">Obstacle : Complexité technique</p>
                <p className="text-sm">
                  Difficulté à convaincre sur la fiabilité des données open data et la pertinence des algorithmes de
      ...
      <div className="py-16 px-4 md:px-8 bg-secondary">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <p>
            J'ai principalement ciblé par <b>appétence et sensibilisation à la donnée</b> plutôt que par taille de
            collectivités. Le démarchage s'est déroulé en 3 phases progressives, chaque phase étant plus ciblée que la
            précédente.
          </p>
          ...
          <div className="space-y-4">
            <ExpandSection id="phase-1" title="Phase 1 : Exploration large (tous secteurs)">
              ...
              <p className="mt-2 italic">
                → Pivot vers les collectivités après identification du meilleur product-market fit
              </p>
            </ExpandSection>
          ...
          <ExpandSection id="process-vente" title="Process de vente détaillé">
            <ol className="list-decimal pl-5 space-y-2">
              <li>
                <b>Qualification initiale :</b> Recherche LinkedIn + analyse des publications open data de la
                collectivité
              </li>
              <li>
                <b>Premier contact :</b> Email personnalisé présentant la proposition de valeur adaptée aux enjeux
                locaux
              </li>
              <li>
              ...
              <li>
                <b>Entretien physique :</b> Présentation personnalisée de la solution Sonor et des besoins spécifiques
                de la collectivité
              </li>
              <li>
                <b>Propale commerciale :</b> Rédaction d'une proposition adaptée (marché{" "}
                <TermExplain term="gré-à-gré">
                  marché public sans appel d'offres, pour montants inférieurs à 40k€
                </TermExplain>
                )
              </li>
            </ol>
          ...
          <div className="rounded-xl p-6 bg-card">
            <p className="text-base">
              <b>Apprentissage clé :</b> Grâce à l'accompagnement et l'expertise de La Banque des Territoires et
              l'association Matrice, nous avons solidifié notre démarche commerciale et notre crédibilité auprès des
              décideurs publics.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <ExpandSection id="sprints-kanbans" title="Sprints Kanbans & cadences">
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <b>Sprints 2–3 semaines :</b> cycles courts pour itérer rapidement sur le prototype et les hypothèses
                business
              </li>
              <li>
      ...
      <div className="py-16 px-4 md:px-8 bg-secondary">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <ExpandSection
            id="concentration-mvp"
            title="Se concentrer sur le MVP de la plateforme SaaS et la cartographie open data avant l'offre complète d'accompagnement"
          >
            <p>
              Nous aurions dû prioriser la livraison d'un{" "}
              <TermExplain term="MVP">Minimum Viable Product, version minimale testable du produit</TermExplain>{" "}
              fonctionnel de la plateforme de cartographie avant de proposer une offre complète incluant
              l'accompagnement des collectivités.
            </p>
            <p className="mt-2">
              Cela aurait permis de valider plus rapidement la proposition de valeur technique et de créer un effet
              démonstration auprès des prospects.
            </p>
          </ExpandSection>

          <ExpandSection id="tests-beta" title="Lancer des tests bêta avec 2-3 villes pilotes">
            <p>Des tests bêta avec quelques villes volontaires auraient permis de :</p>
          ...
          <ExpandSection id="partenariats-strategiques" title="Nouer des partenariats stratégiques plus tôt">
            <p>
              Identifier et contractualiser des partenariats avec des acteurs clés du secteur (associations d'élus,
              réseaux de villes, consultants en environnement) dès le début pour faciliter l'accès au marché.
            </p>
          </ExpandSection>
        </div>
      </div>
      ...
      <div className="py-16 px-4 md:px-8 bg-background">
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <section className="rounded-xl p-6 bg-card">
            <p className="text-lg">
              Le projet SONOR n'est pas devenu une start-up à proprement parlé, mais l'expérience a été formatrice à
          ...
          <div className="space-y-6">
            ...
            <ExpandSection id="learning-2" title="2. Cycles de vente B2G longs">
              <p>
                Les cycles de vente auprès des collectivités sont très longs (6-12 mois minimum), mais nous manquons de
            ...
            <ExpandSection id="learning-3" title="3. Positionnement flou">
              <p>
                Notre positionnement entre plateforme SaaS et accompagnement conseil n'était pas assez clair. Il fallait
                choisir un angle d'attaque plus précis pour faciliter la compréhension de la proposition de valeur.
              </p>
            </ExpandSection>
          </div>
          ...
          <div className="mt-10">
            ...
            <div className="space-y-4">
              <ExpandSection
                id="learning-perso-1"
                title="1. Appétence pour l'exploration et l'analyse"
                defaultOpen={true}
              >
                <p>
                  J'ai confirmé mon goût pour l'étude approfondie de problématiques complexes, la recherche de solutions
                  concrètes, et la capacité à transformer des apprentissages techniques et des données en réponses
                  adaptées aux besoins terrain. Cette approche analytique et exploratoire guide aujourd'hui ma pratique
                  produit.
                </p>
              </ExpandSection>
              ...
              <ExpandSection id="learning-perso-2" title="2. Produits à impact">
                <p>
                  Confirmation de mon intérêt pour les produits à fort impact sociétal et environnemental, où la
                  technologie sert un objectif d'utilité publique.
                </p>
              </ExpandSection>

              <ExpandSection id="learning-perso-3" title="3. Aller-retour terrain ↔ conception">
                <p>
                  Importance de la confrontation régulière avec le terrain pour affiner la vision produit et éviter de
                  construire dans l'abstrait.
                </p>
              </ExpandSection>
          ...
          <section className="rounded-xl p-6 bg-card mt-10">
            <p className="text-lg">
              <b>Conclusion.</b> SONOR a confirmé mon goût pour la transformation de problématiques en solutions
              data-driven et m'a permis d'acquérir une expérience précieuse en product management 0→1, de la discovery à
          ...
          <section className="grid md:grid-cols-2 gap-6 items-start">
            <div className="space-y-4">
              ...
              <p>
                ...
                incubated by <b>Matrice Association</b> and <b>Banque des Territoires</b>. The challenge:{" "}
                <b>noise pollution</b>—an under-addressed public health issue with strong societal impact.
              </p>
              <p>
  ...
  return (
    <div>
      ...
      <section className="relative h-[50vh] md:h-[60vh] overflow-hidden">
        <img src={sonorHero} alt="SONOR hero" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <FilterChips chips={audiences} activeChip={activeAudience} onChipChange={setActiveAudience} />
      </div>

      <div className="max-w-6xl mx-auto px-4 pb-16">{getContent()}</div>
